pipeline {
    ...
    parameters {
        ...
        string(name: 'YOUR_IP_CIDR', defaultValue: '0.0.0.0/0', description: 'Your public IP in CIDR, e.g. 49.36.55.12/32')
        booleanParam(name: 'APPLY_TERRAFORM', defaultValue: false, description: 'Force Terraform apply')
    }
